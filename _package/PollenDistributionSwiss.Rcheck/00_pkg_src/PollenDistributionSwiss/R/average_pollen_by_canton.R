...
#' @param PATH_map path for map directory
#'
...
plot_specific_pollen <- function(polline_df, pollen_type = "grass", PATH_map='2025_GEOM_TK') {
  world_path = paste0(PATH_map, '/01_INST/Gesamtflaaeche_gf/K4_kant20220101_gf/K4kant20220101gf_ch2007Poly.shp')
  l_path = paste0(PATH_map, '/00_TOPO/K4_seenyyyymmdd/k4seenyyyymmdd11_ch2007Poly.shp' )
