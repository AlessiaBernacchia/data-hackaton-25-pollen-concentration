...
\item[Imports]\AsIs{dplyr, sf, ggplot2, httr, jsonlite, httr2, knitr, readr,
tibble, tidyr, utils}
...
\end{ExampleCode}
\end{Examples}
\HeaderA{get\_pollen\_forecast\_with\_cache}{Read data from the API (no caching)}{get.Rul.pollen.Rul.forecast.Rul.with.Rul.cache}
%
\begin{Description}
